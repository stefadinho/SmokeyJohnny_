...
{{< gallery caption-effect="fade" >}}
  {{< figure link="/img/0.jpg" caption="Hexagon" >}}
  {{< figure link="/img/1.jpg" caption="Sphere" >}}
  {{< figure link="/img/2.jpg" caption="Triangle" alt="This is a long comment about a triangle" >}}
{{< /gallery >}}
{{< load-photoswipe >}}
